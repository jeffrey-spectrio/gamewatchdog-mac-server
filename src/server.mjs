...
const COMMANDS = new Set(["RELOGIN_HOME", "EXTEND_30", "CANCEL_AUTO_RELOGIN", "CLEAR_TAKEOVER", "START_FARM", "STOP_FARM", "ENABLE_WATCHDOG", "DISABLE_WATCHDOG", "START_TICKET", "STOP_TICKET", "CAPTURE_SCREEN", "RESTART_GAME", "TAP_SCREEN", "TAP_AND_CAPTURE", "START_REMOTE_CONTROL", "STOP_REMOTE_CONTROL", "NAV_BACK", "NAV_HOME", "NAV_RECENTS", "NAV_BACK_CAPTURE", "NAV_HOME_CAPTURE", "NAV_RECENTS_CAPTURE"]);
