...
const COMMANDS = new Set(["RELOGIN_HOME", "EXTEND_30", "CANCEL_AUTO_RELOGIN", "START_FARM", "STOP_FARM", "ENABLE_WATCHDOG", "DISABLE_WATCHDOG", "START_TICKET", "STOP_TICKET", "CAPTURE_SCREEN", "RESTART_GAME", "TAP_SCREEN", "START_REMOTE_CONTROL", "STOP_REMOTE_CONTROL"]);
